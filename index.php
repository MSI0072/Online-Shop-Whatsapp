...
<body>
        ...
        <section class="menu section bd-container" id="menu">
            ...
            <div class="menu__container bd-grid">
                <?php
    						...
    						foreach($json_decoded as $index=>$result){
                               
        				?>
                <div class="menu__content">
                    <img src=<?php echo $result['link']; ?> alt="" class="menu__img">
                    <h3 class="menu__name"><?php echo $result['nama']; ?></h3>
                    <span class="menu__detail"><?php echo $result['deskripsi']; ?></span>
                    <span class="menu__preci">Rp. <?php echo $result['harga']; ?></span>
                    <a class="button menu__button" href="#<?php echo $result['href']; ?>" data-bs-toggle="collapse"
                    ...
                    <div class="collapse" id="<?php echo $result['href']; ?>">
                        <form action="redirect.php" method="POST">
                            <div class="mb-3">
                                <label for="exampleInputName" class="form-label">Jenis Layanan</label>
                                <select class="form-select form-select-sm" aria-label=".form-select-sm example"
                                    name="jenis" id="jenis" data-trigger="">
                            ...
                            <div class="mb-3">
                                <label for="exampleInputName" class="form-label">Jenis Produk</label>
                                <select class="form-select form-select-sm" aria-label=".form-select-sm example"
                                    name="produk" id="produk" data-trigger="">
                                    <option selected>Tipe</option>
                                    <?php
                                        foreach($result['data'] as $index=>$results){
                                       ?>
                                    <option value="<?php echo $results; ?>"><?php echo $results; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="exampleInputDate" class="form-label" name="label_jani">Tanggal</label>
                                <input type="date" class="form-control" id="date" name="date" aria-describedby="date"
                                    placeholder="Tanggal" required>
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlTextarea1" class="form-label">Note</label>
                                <textarea class="form-control" rows="3" id="note" name="note" placeholder="catatan"
                                    required></textarea>
                            </div>
    ...
    <!--========== PRIVACY POLICE  ==========-->
    <div class="modal fade" id="pp" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="ppLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Privacy Policy for notaris nurul fadilah, S.H.</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>At notaris nurul fadilah, S.H., accessible from https://nurulfadilah.herokuapp.com, one of our
                        main priorities is the privacy of our visitors. This Privacy Policy document contains types of
                        information that is collected and recorded by notaris nurul fadilah, S.H. and how we use it.</p>
                    ...
                    <p>notaris nurul fadilah, S.H. follows a standard procedure of using log files. These files log
                    ...
                    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of
                        notaris nurul fadilah, S.H..</p>

                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                        that are used in their respective advertisements and links that appear on notaris nurul fadilah,
                        S.H., which are sent directly to users' browser. They automatically receive your IP address when
                    ...
                    <p>Note that notaris nurul fadilah, S.H. has no access to or control over these cookies that are
                        used by third-party advertisers.</p>

                    <h2>Third Party Privacy Policies</h2>

                    <p>notaris nurul fadilah, S.H.'s Privacy Policy does not apply to other advertisers or websites.
                        Thus, we are advising you to consult the respective Privacy Policies of these third-party ad
                        servers for more detailed information. It may include their practices and instructions about how
                    ...
                    <p>notaris nurul fadilah, S.H. does not knowingly collect any Personal Identifiable Information from
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                        website with regards to the information that they shared and/or collect in notaris nurul
                        fadilah, S.H.. This policy is not applicable to any information collected offline or via
    ...
    <!--========== TOC  ==========-->
    <div class="modal fade" id="toc" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="tocLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <p>Welcome to nurul fadilah, S.H.!</p>

                    <p>These terms and conditions outline the rules and regulations for the use of nurul fadilah, S.H.'s
                        Website, located at https://nurulfadilah.herokuapp.com.</p>

                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                        nurul fadilah, S.H. if you do not agree to take all of the terms and conditions stated on this
                        page.</p>
                    ...
                    <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                        ...
                        taken as interchangeable and therefore as referring to same. Our Terms and Conditions were
                    ...
                    <p>We employ the use of cookies. By accessing nurul fadilah, S.H., you agreed to use cookies in
                        agreement with the nurul fadilah, S.H.'s Privacy Policy.</p>
                    ...
                    <p>Unless otherwise stated, nurul fadilah, S.H. and/or its licensors own the intellectual property
                        rights for all material on nurul fadilah, S.H.. All intellectual property rights are reserved.
                        You may access this from nurul fadilah, S.H. for your own personal use subjected to restrictions
                        set in these terms and conditions.</p>

                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from nurul fadilah, S.H.</li>
                        <li>Sell, rent or sub-license material from nurul fadilah, S.H.</li>
                        <li>Reproduce, duplicate or copy material from nurul fadilah, S.H.</li>
                        <li>Redistribute content from nurul fadilah, S.H.</li>
                    </ul>

                    <p>This Agreement shall begin on the date hereof.</p>

                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                        information in certain areas of the website. nurul fadilah, S.H. does not filter, edit, publish
                        or review Comments prior to their presence on the website. Comments do not reflect the views and
                        opinions of nurul fadilah, S.H.,its agents and/or affiliates. Comments reflect the views and
                        opinions of the person who post their views and opinions. To the extent permitted by applicable
                        laws, nurul fadilah, S.H. shall not be liable for the Comments or for any liability, damages or
                    ...
                    <p>nurul fadilah, S.H. reserves the right to monitor all Comments and to remove any Comments which
                    ...
                    <p>You hereby grant nurul fadilah, S.H. a non-exclusive license to use, reproduce, edit and
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                        ...
                        hyperlink compensates the absence of nurul fadilah, S.H.; and (d) the link is in the context of
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                        our website, you must inform us by sending an e-mail to nurul fadilah, S.H.. Please include your
                    ...
                    <p>No use of nurul fadilah, S.H.'s logo or other artwork will be allowed for linking absent a
    ...
    <!--========== Disclaimer  ==========-->
    <div class="modal fade" id="disclaimer" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="disclaimerLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Disclaimer for nurul fadilah, S.H.</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>If you require any more information or have any questions about our site's disclaimer, please
                        feel free to contact us by email at nurulnot@yahoo.com</p>

                    <h2>Disclaimers for nurul fadilah, S.H.</h2>

                    <p>All the information on this website - https://nurulfadilah.herokuapp.com - is published in good
                        faith and for general information purpose only. nurul fadilah, S.H. does not make any warranties
                        about the completeness, reliability and accuracy of this information. Any action you take upon
                        the information you find on this website (nurul fadilah, S.H.), is strictly at your own risk.
                        nurul fadilah, S.H. will not be liable for any losses and/or damages in connection with the use
                        of our website. Our Disclaimer was generated with the help of the <a
                            href="https://www.privacypolicyonline.com/disclaimer-generator/">Disclaimer Generator</a>
                        and the <a href="https://www.generateprivacypolicy.com">Privacy Policy Generator</a>.</p>
    ...
    <footer class="footer section bd-container">
        <div class="footer__container bd-grid">
            ...
            <div class="footer__content">
                ...
                <ul>
                    <li><a href="#contact" class="footer__link">Contact us</a></li>
                    <li><a data-bs-toggle="modal" data-bs-target="#pp" role="button" class="footer__link">Privacy policy</a></li>
                    <li><a data-bs-toggle="modal" data-bs-target="#toc" role="button" class="footer__link">Terms of services</a></li>
                    <li><a data-bs-toggle="modal" data-bs-target="#disclaimer" role="button" class="footer__link">Disclaimer</a></li>
                </ul>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('input[name="ug"]').text(function name() {
                $(this).val(url_wa);
            });
        });
    </script>
